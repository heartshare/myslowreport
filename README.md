...
增加增长率月份统计表
```Java
CREATE TABLE `myslow_history_grow_rate_monthly` (
  `Id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id(自增量)',
  `MyInsName` varchar(64) NOT NULL COMMENT 'MySQL实例名称',
  `StatDate` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '统计日期',
  `LastMonthTotal` int(11) NOT NULL DEFAULT '0' COMMENT '上个月的慢日志总数',
  `LastLastMonthTotal` int(11) NOT NULL DEFAULT '0' COMMENT '上上个月的慢日志总数',
  `LastMonthUniq` int(11) NOT NULL DEFAULT '0' COMMENT '上个月的慢日志独立数',
  `LastLastMonthUniq` int(11) NOT NULL DEFAULT '0' COMMENT '上上个月的慢日志独立数',
  `TotalChainRate` decimal(10,2) DEFAULT NULL COMMENT '总慢日志语句数环比增长',
  `UniqChainRate` decimal(10,2) DEFAULT NULL COMMENT '独立慢日志语句数环比增长',
  PRIMARY KEY (`Id`),
  UNIQUE KEY `idx_MyInsName_StatDate` (`MyInsName`,`StatDate`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
```
...
增加慢日志月份报告表
```Java
CREATE TABLE `myslow_history_10_120_3306_monthly` (
  `db_max` varchar(100) DEFAULT NULL,
  `user_max` varchar(100) DEFAULT NULL,
  `checksum` bigint(20) unsigned NOT NULL,
  `sample` text NOT NULL,
  `ts_min` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `ts_max` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `ts_cnt` bigint(20) unsigned DEFAULT '0',
  `Query_time_sum` decimal(12,9) DEFAULT '0.000000000',
  `Query_time_min` decimal(12,9) DEFAULT '0.000000000',
  `Query_time_max` decimal(12,9) DEFAULT '0.000000000',
  `Query_time_pct_95` decimal(12,9) DEFAULT '0.000000000',
  `Query_time_stddev` decimal(12,9) DEFAULT '0.000000000',
  `Query_time_median` decimal(12,9) DEFAULT '0.000000000',
  `Lock_time_sum` decimal(12,9) DEFAULT '0.000000000',
  `Lock_time_min` decimal(12,9) DEFAULT '0.000000000',
  `Lock_time_max` decimal(12,9) DEFAULT '0.000000000',
  `Lock_time_pct_95` decimal(12,9) DEFAULT '0.000000000',
  `Lock_time_stddev` decimal(12,9) DEFAULT '0.000000000',
  `Lock_time_median` decimal(12,9) DEFAULT '0.000000000',
  `Rows_sent_sum` bigint(20) unsigned DEFAULT '0',
  `Rows_sent_min` bigint(20) unsigned DEFAULT '0',
  `Rows_sent_max` bigint(20) unsigned DEFAULT '0',
  `Rows_sent_pct_95` bigint(20) unsigned DEFAULT '0',
  `Rows_sent_stddev` bigint(20) unsigned DEFAULT '0',
  `Rows_sent_median` bigint(20) unsigned DEFAULT '0',
  `Rows_examined_sum` bigint(20) unsigned DEFAULT '0',
  `Rows_examined_min` bigint(20) unsigned DEFAULT '0',
  `Rows_examined_max` bigint(20) unsigned DEFAULT '0',
  `Rows_examined_pct_95` bigint(20) unsigned DEFAULT '0',
  `Rows_examined_stddev` bigint(20) unsigned DEFAULT '0',
  `Rows_examined_median` bigint(20) unsigned DEFAULT '0',
  `Rows_affected_sum` float DEFAULT NULL,
  `Rows_affected_min` float DEFAULT NULL,
  `Rows_affected_max` float DEFAULT NULL,
  `Rows_affected_pct_95` float DEFAULT NULL,
